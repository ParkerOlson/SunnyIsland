 ...
 */
public class ComplexDirectionalLightShader extends Shader {
    ...
    public ComplexDirectionalLightShader(ComplexSampleStencilShader csss) {
        super("vertex2.glsl", "cmplx_dir_light_fragment.glsl");
